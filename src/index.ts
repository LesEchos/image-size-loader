...
export default function loader(this: LoaderContext<Options>, content: Buffer): string {
  ...
  if (typeof options.emitFile === 'undefined' || options.emitFile) {
    ...
    /**
     * TODO: ask 'webpack' to update content type
     * @see {@link https://webpack.js.org/api/loaders/#thisemitfile}
     */
    this.emitFile(outputPath, content as unknown as string, undefined, assetInfo);
  }
